...
public class DataCollectorTuneRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.campaignName == null ? dataCollectorTuneRequest.campaignName == null : this.campaignName.equals(dataCollectorTuneRequest.campaignName)) &&
        (this.deviceId == null ? dataCollectorTuneRequest.deviceId == null : this.deviceId.equals(dataCollectorTuneRequest.deviceId)) &&
        (this.eventProperties == null ? dataCollectorTuneRequest.eventProperties == null : this.eventProperties.equals(dataCollectorTuneRequest.eventProperties)) &&
        (this.eventTimestamp == null ? dataCollectorTuneRequest.eventTimestamp == null : this.eventTimestamp.equals(dataCollectorTuneRequest.eventTimestamp)) &&
        (this.requestType == null ? dataCollectorTuneRequest.requestType == null : this.requestType.equals(dataCollectorTuneRequest.requestType)) &&
        (this.sendTimestamp == null ? dataCollectorTuneRequest.sendTimestamp == null : this.sendTimestamp.equals(dataCollectorTuneRequest.sendTimestamp)) &&
        (this.userId == null ? dataCollectorTuneRequest.userId == null : this.userId.equals(dataCollectorTuneRequest.userId));
  }
