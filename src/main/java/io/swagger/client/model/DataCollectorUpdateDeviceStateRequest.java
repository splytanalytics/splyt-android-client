...
public class DataCollectorUpdateDeviceStateRequest {
   ...
   **/
  @ApiModelProperty(required = true, value = "Unique ID of the device for which state is being updated")
  ...
  public boolean equals(Object o) {
    ...
    return (this.deviceId == null ? dataCollectorUpdateDeviceStateRequest.deviceId == null : this.deviceId.equals(dataCollectorUpdateDeviceStateRequest.deviceId)) &&
        (this.eventProperties == null ? dataCollectorUpdateDeviceStateRequest.eventProperties == null : this.eventProperties.equals(dataCollectorUpdateDeviceStateRequest.eventProperties)) &&
        (this.eventTimestamp == null ? dataCollectorUpdateDeviceStateRequest.eventTimestamp == null : this.eventTimestamp.equals(dataCollectorUpdateDeviceStateRequest.eventTimestamp)) &&
        (this.requestType == null ? dataCollectorUpdateDeviceStateRequest.requestType == null : this.requestType.equals(dataCollectorUpdateDeviceStateRequest.requestType)) &&
        (this.sendTimestamp == null ? dataCollectorUpdateDeviceStateRequest.sendTimestamp == null : this.sendTimestamp.equals(dataCollectorUpdateDeviceStateRequest.sendTimestamp)) &&
        (this.userId == null ? dataCollectorUpdateDeviceStateRequest.userId == null : this.userId.equals(dataCollectorUpdateDeviceStateRequest.userId));
  }
