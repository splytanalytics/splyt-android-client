...
public class DataCollectorBeginTransactionRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.category == null ? dataCollectorBeginTransactionRequest.category == null : this.category.equals(dataCollectorBeginTransactionRequest.category)) &&
        (this.deviceId == null ? dataCollectorBeginTransactionRequest.deviceId == null : this.deviceId.equals(dataCollectorBeginTransactionRequest.deviceId)) &&
        (this.eventProperties == null ? dataCollectorBeginTransactionRequest.eventProperties == null : this.eventProperties.equals(dataCollectorBeginTransactionRequest.eventProperties)) &&
        (this.eventTimestamp == null ? dataCollectorBeginTransactionRequest.eventTimestamp == null : this.eventTimestamp.equals(dataCollectorBeginTransactionRequest.eventTimestamp)) &&
        (this.requestType == null ? dataCollectorBeginTransactionRequest.requestType == null : this.requestType.equals(dataCollectorBeginTransactionRequest.requestType)) &&
        (this.sendTimestamp == null ? dataCollectorBeginTransactionRequest.sendTimestamp == null : this.sendTimestamp.equals(dataCollectorBeginTransactionRequest.sendTimestamp)) &&
        (this.timeout == null ? dataCollectorBeginTransactionRequest.timeout == null : this.timeout.equals(dataCollectorBeginTransactionRequest.timeout)) &&
        (this.timeoutMode == null ? dataCollectorBeginTransactionRequest.timeoutMode == null : this.timeoutMode.equals(dataCollectorBeginTransactionRequest.timeoutMode)) &&
        (this.transactionId == null ? dataCollectorBeginTransactionRequest.transactionId == null : this.transactionId.equals(dataCollectorBeginTransactionRequest.transactionId)) &&
        (this.userId == null ? dataCollectorBeginTransactionRequest.userId == null : this.userId.equals(dataCollectorBeginTransactionRequest.userId));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.timeoutMode == null ? 0: this.timeoutMode.hashCode());
