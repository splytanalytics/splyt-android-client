...
public class DataCollectorBaseRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.deviceId == null ? dataCollectorBaseRequest.deviceId == null : this.deviceId.equals(dataCollectorBaseRequest.deviceId)) &&
        (this.eventProperties == null ? dataCollectorBaseRequest.eventProperties == null : this.eventProperties.equals(dataCollectorBaseRequest.eventProperties)) &&
        (this.eventTimestamp == null ? dataCollectorBaseRequest.eventTimestamp == null : this.eventTimestamp.equals(dataCollectorBaseRequest.eventTimestamp)) &&
        (this.requestType == null ? dataCollectorBaseRequest.requestType == null : this.requestType.equals(dataCollectorBaseRequest.requestType)) &&
        (this.sendTimestamp == null ? dataCollectorBaseRequest.sendTimestamp == null : this.sendTimestamp.equals(dataCollectorBaseRequest.sendTimestamp)) &&
        (this.userId == null ? dataCollectorBaseRequest.userId == null : this.userId.equals(dataCollectorBaseRequest.userId));
  }
