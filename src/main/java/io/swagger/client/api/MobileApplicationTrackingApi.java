...
public class MobileApplicationTrackingApi {
  ...
  * 
   ...
   * @return void
  */
  public void submitTuneRequest (String customerId, DataCollectorTuneRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = request;
    // verify the required parameter 'customerId' is set
    if (customerId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'customerId' when calling submitTuneRequest",
        new ApiException(400, "Missing the required parameter 'customerId' when calling submitTuneRequest"));
    }
  ...
  */
  public void submitTuneRequest (String customerId, DataCollectorTuneRequest request, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
