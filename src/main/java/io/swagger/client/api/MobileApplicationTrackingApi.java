...
import io.swagger.client.model.DataCollectorTuneRequest;
...
public class MobileApplicationTrackingApi {
  ...
  * 
   ...
   * @param request Tune campaign tracking information
   * @return void
  */
  public void handleTuneRequestUsingPOST (String customerId, DataCollectorTuneRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = request;
    // verify the required parameter 'customerId' is set
    if (customerId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'customerId' when calling handleTuneRequestUsingPOST",
        new ApiException(400, "Missing the required parameter 'customerId' when calling handleTuneRequestUsingPOST"));
    }
   ...
   * Submit mobile application tracking data for Tune applications
   * 
   * @param customerId customerId   * @param request Tune campaign tracking information
  */
  public void handleTuneRequestUsingPOST (String customerId, DataCollectorTuneRequest request, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
    ...
    // create path and map variables
    String path = "/v2/tune".replaceAll("\\{format\\}","json");
