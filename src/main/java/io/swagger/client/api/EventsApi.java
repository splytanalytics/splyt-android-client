...
public class EventsApi {
  ...
  * 
   ...
   * @return void
  */
  public void createEvent (String customerId, NewEventRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = request;
    // verify the required parameter 'customerId' is set
    if (customerId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'customerId' when calling createEvent",
        new ApiException(400, "Missing the required parameter 'customerId' when calling createEvent"));
    }
  ...
  */
  public void createEvent (String customerId, NewEventRequest request, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
