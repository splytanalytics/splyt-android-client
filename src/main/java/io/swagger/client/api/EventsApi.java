...
import io.swagger.client.model.NewEventRequest;
...
public class EventsApi {
  ...
  * 
   ...
   * @param request Similar to transactions, the details of that event
   * @return void
  */
  public void createEventUsingPOST (String customerId, NewEventRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = request;
    // verify the required parameter 'customerId' is set
    if (customerId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'customerId' when calling createEventUsingPOST",
        new ApiException(400, "Missing the required parameter 'customerId' when calling createEventUsingPOST"));
    }

    // create path and map variables
    String path = "/v2/events";
   ...
   * Creates a single event (a transaction with no duration)
   * 
   * @param customerId customerId   * @param request Similar to transactions, the details of that event
  */
  public void createEventUsingPOST (String customerId, NewEventRequest request, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
    ...
    // create path and map variables
    String path = "/v2/events".replaceAll("\\{format\\}","json");
