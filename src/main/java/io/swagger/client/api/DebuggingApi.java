...
public class DebuggingApi {
  ...
  * Forces debugging to be disabled for the customer
   ...
   * @return void
  */
  public void disableDebuggerUsingDELETE (String customerId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'customerId' is set
    if (customerId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'customerId' when calling disableDebuggerUsingDELETE",
        new ApiException(400, "Missing the required parameter 'customerId' when calling disableDebuggerUsingDELETE"));
    }

    // create path and map variables
    String path = "/v2/_debug/{customerId}".replaceAll("\\{" + "customerId" + "\\}", apiInvoker.escapeString(customerId.toString()));
   ...
   * @param customerId customerId
  */
  public void disableDebuggerUsingDELETE (String customerId, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/v2/_debug/{customerId}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "customerId" + "\\}", apiInvoker.escapeString(customerId.toString()));
  ...
  * Debugging is only enabled for a limited period of time (default is one hour)
   ...
   * @return void
  */
  public void enableDebuggerUsingPOST (String customerId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'customerId' is set
    if (customerId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'customerId' when calling enableDebuggerUsingPOST",
        new ApiException(400, "Missing the required parameter 'customerId' when calling enableDebuggerUsingPOST"));
    }
   ...
   * @param customerId customerId
  */
  public void enableDebuggerUsingPOST (String customerId, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
