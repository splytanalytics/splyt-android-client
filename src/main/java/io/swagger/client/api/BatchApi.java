...
public class BatchApi {
  ...
  * For this to work, you will need to specify the value of the request_type field of each element in the list, which indicates the type of the element. For example, to submit a batch containing a DataCollectorNewUserRequest you would specify the value &#x60;newUser&#x60; as the request_type for your DataCollectorNewUserRequest element. Convention is DataCollectorSomeTypeRequest , someType (DataCollectorNewUserRequest , newUser, DataCollectorNewDeviceRequest , newDevice, etc
   ...
   * @return void
  */
  public void submitBatch (DataCollectorBatchRequest batchRequest, String customerId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = batchRequest;
    // verify the required parameter 'batchRequest' is set
    if (batchRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'batchRequest' when calling submitBatch",
        new ApiException(400, "Missing the required parameter 'batchRequest' when calling submitBatch"));
    }
  ...
  */
  public void submitBatch (DataCollectorBatchRequest batchRequest, String customerId, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = batchRequest;
