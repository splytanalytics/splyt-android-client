...
import io.swagger.client.model.BatchRequestResult;
...
public class BatchApi {
  ...
  * For this to work, you will need to specify the value of the request_type field of each element in the list, which indicates the type of the element. For example, to submit a batch containing a DataCollectorNewUserRequest you would specify the value &#x60;newUser&#x60; as the request_type for your DataCollectorNewUserRequest element. Convention is DataCollectorSomeTypeRequest -&gt; someType (DataCollectorNewUserRequest -&gt; newUser, DataCollectorNewDeviceRequest -&gt; newDevice, etc). If any invalid requests are detected in the batch, a HTTP 207 (Multi-Status) will be returned and the body will contain the status of each of the requests, in the order in which they were submitted, with detailed error messages and the JSON of the request returned for any invalid requests.
   ...
   * @param batchRequest The batch of requests to submit
   * @return List<BatchRequestResult>
  */
  public List<BatchRequestResult> submitBatch (String customerId, DataCollectorBatchRequest batchRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = batchRequest;
    // verify the required parameter 'customerId' is set
    if (customerId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'customerId' when calling submitBatch",
        new ApiException(400, "Missing the required parameter 'customerId' when calling submitBatch"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (List<BatchRequestResult>) ApiInvoker.deserialize(localVarResponse, "array", BatchRequestResult.class);
      } else {
         return null;
      }
   ...
   * Submit a batch of requests as an array of input models
   * For this to work, you will need to specify the value of the request_type field of each element in the list, which indicates the type of the element. For example, to submit a batch containing a DataCollectorNewUserRequest you would specify the value &#x60;newUser&#x60; as the request_type for your DataCollectorNewUserRequest element. Convention is DataCollectorSomeTypeRequest -&gt; someType (DataCollectorNewUserRequest -&gt; newUser, DataCollectorNewDeviceRequest -&gt; newDevice, etc). If any invalid requests are detected in the batch, a HTTP 207 (Multi-Status) will be returned and the body will contain the status of each of the requests, in the order in which they were submitted, with detailed error messages and the JSON of the request returned for any invalid requests.
   * @param customerId customerId   * @param batchRequest The batch of requests to submit
  */
  public void submitBatch (String customerId, DataCollectorBatchRequest batchRequest, final Response.Listener<List<BatchRequestResult>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = batchRequest;
      ...
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<BatchRequestResult>) ApiInvoker.deserialize(localVarResponse,  "array", BatchRequestResult.class));
