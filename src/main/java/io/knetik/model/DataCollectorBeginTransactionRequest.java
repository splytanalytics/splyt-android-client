...
public class DataCollectorBeginTransactionRequest extends DataCollectorBaseRequest {
   ...
   */
  @JsonAdapter(TimeoutModeEnum.Adapter.class)
  public enum TimeoutModeEnum {
    ...
    public static class Adapter extends TypeAdapter<TimeoutModeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final TimeoutModeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public TimeoutModeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return TimeoutModeEnum.fromValue(String.valueOf(value));
      }
    }
  }
